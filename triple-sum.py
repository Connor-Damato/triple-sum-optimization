...
def main():
    ...
    for j in range (10,200):
        ...
        for i in range(1, num_iterations):
            ...
            start = time.time()
            num_steps = 0
            solution1 = optimized_triple_sum(array)
            end = time.time()
            ...
            start = time.time()
            num_steps = 0
            solution2 = search_skip_sum(array)
            end = time.time()
            ...
            start = time.time()
            num_steps = 0
            solution3 = default_three_sum(array)
            end = time.time()
            ...
            if solution1 != solution3 or solution2 != solution3:
                # throw error
